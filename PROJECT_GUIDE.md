...
6.  **Immersive Automation UX**: 매크로 실행 시 **전체화면**으로 전환하고 동작 간 **4.0초의 지연**을 두어 사용자가 모든 과정을 놓치지 않고 학습할 수 있도록 최적화했습니다. (v3.2)
7.  **Data Portability & Sharing**: 매크로 설정의 JSON Import/Export 뿐만 아니라, **개별 매크로 공유**를 지원하여 유저 간의 지식 전파를 돕습니다.
