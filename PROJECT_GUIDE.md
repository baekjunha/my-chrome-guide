# 🚀 My Chrome Guide: Extension 프로젝트 상세 가이드 (v3.1)

본 프로젝트는 사용자가 크롬 브라우저를 더욱 스마트하게 사용할 수 있도록 돕는 **학습형 팁 큐레이션 및 웹 자동화 확장 프로그램**입니다. v3.1에서는 **개별 매크로 공유 기능**, **풍성한 온보딩 경험**, 그리고 **플랫폼 비전 설계**를 통해 제품을 완성했습니다.
...
| **1클릭 매크로** | 반복 작업 자동화 엔진 및 **개별 매크로 공유(Share)** 기능 지원 | ✅ Ver 3.1 |
...
6.  **Data Portability & Sharing**: 매크로 설정의 JSON Import/Export 뿐만 아니라, **개별 매크로 공유**를 지원하여 유저 간의 지식 전파를 돕습니다.
