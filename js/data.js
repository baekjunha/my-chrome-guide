export const tips = [
  ...
  },
  {
    ...
    desc: "동영상을 팝업으로 띄웁니다. 유튜브는 영상 위에서 우클릭을 두 번 하세요.",
    desc_en: "Watch video in a floating window. On YouTube, right-click twice on the video.",
  ...
  // ── AI 기능 ──────────────────────────────────
  {
    ...
    desc: "(실험적) 열린 탭이 너무 많을 때 AI가 비슷한 주제끼리 자동으로 그룹을 만들어줍니다.",
  ...
  },
  {
    ...
    desc: "(실험적) 이메일이나 댓글 등 텍스트 입력창에서 AI가 문장을 다듬거나 새로 작성해 줍니다.",
  ...
  },
  {
    ...
    desc: "주소창에 @gemini를 입력하고 한 칸 띄우면 구글 제미나이와 즉시 대화할 수 있습니다.",
  ...
  },
  {
    ...
    desc: "(실험적) 텍스트 설명만으로 나만의 커스텀 크롬 테마를 만듭니다.",
  ...
  },
  {
    ...
    desc: "(실험적) '저번에 본 신발 사이트'처럼 자연어로 검색하세요. (순차적 배포 중)",
  ...
  },
  {
    ...
    desc: "클릭 전에 페이지 내용을 미리 팝업으로 확인합니다. (chrome://flags에서 활성화 필요)",
