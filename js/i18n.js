export const I18N = {
  ko: {
    ...
    categories: { "전체": "전체", "탭/창": "탭/창", "탐색": "탐색", "주소창/검색": "주소창/검색", "화면": "화면", "북마크": "북마크", "편집": "편집", "프로필/공간": "프로필/공간", "AI 기능": "AI 기능", "개발자": "개발자", "설정": "설정", "이스터에그": "이스터에그", "시스템": "시스템" },
    emptyFav: "아직 저장된 보관함이 없습니다<br><small style=\"font-weight:400; opacity:0.7\">팁에 있는 아이콘을 눌러보세요.</small>",
    favAdd: "즐겨찾기에 추가",
    favRemove: "즐겨찾기에서 제거",
    emptySearch: "검색 결과가 없습니다",
    emptySearchDesc: "다른 키워드로 검색하거나 아래 추천 항목을 확인해 보세요.",
    ...
    securityWarning: "비밀번호 등 민감한 정보는 저장하지 마세요!",
    ...
    macroModalTitle: "1클릭 매크로 설계",
    macroModalDesc: "복잡한 메뉴 깊숙이 숨겨진 페이지를 버튼 하나로 찾아가는 '자율주행 북마크'입니다.",
    macroNameLabel: "매크로 이름",
    macroNamePlaceholder: "예: 네이버 메일 수신확인, 학사행정",
    macroUrlLabel: "시작 URL",
    macroUrlPlaceholder: "https://...",
    macroStepsLabel: "매크로 동작 정의",
    macroSave: "변경사항 저장",
    macroAddManual: "+ 수동 스텝 추가",
    onboardingTitle: "환영합니다!",
    onboardingDesc: "크롬 전문가들이 선별한 <strong>130여 개의 꿀팁</strong>과,<br>귀찮은 작업을 자동화하는 <strong>1클릭 매크로</strong>가 준비되었습니다.<br>이제 더 빠르고 똑똑한 브라우징을 시작하세요.",
    onboardingFeature1: "139+ 팁 뱅크",
    onboardingFeature2: "1클릭 매크로",
    onboardingFeature3: "개인 메모",
    onboardingFeature4: "100% 보안 준수",
    onboardingStart: "네, 완벽해요! 시작하기",
    workspacePersonal: "개인용",
    workspaceCompany: "회사용",
    roleAdmin: "관리자",
    roleViewer: "뷰어"
  },
  en: {
    ...
    categories: { "전체": "All", "탭/창": "Tab/Window", "탐색": "Navigation", "주소창/검색": "Omnibox", "화면": "Screen", "북마크": "Bookmarks", "편집": "Editing", "프로필/공간": "Profile/Space", "AI 기능": "AI Features", "개발자": "Developer", "설정": "Settings", "이스터에그": "Easter Eggs", "시스템": "System" },
    ...
    securityWarning: "Do not save sensitive data like passwords!",
    ...
    macroModalTitle: "1-Click Macro Design",
    macroModalDesc: "It's an 'autonomous bookmark' that finds pages hidden deep within complex menus with a single button.",
    macroNameLabel: "Macro Name",
    macroNamePlaceholder: "Ex: Check Naver Mail, Academic Admin",
    macroUrlLabel: "Start URL",
    macroUrlPlaceholder: "https://...",
    macroStepsLabel: "Define Macro Actions",
    macroSave: "Save Changes",
    macroAddManual: "+ Add Manual Step",
    onboardingTitle: "Welcome!",
    onboardingDesc: "We've prepared over <strong>130 tips</strong> curated by Chrome experts, and <strong>1-Click Macros</strong> to automate tedious tasks.<br>Start browsing faster and smarter now.",
    onboardingFeature1: "139+ Tip Bank",
    onboardingFeature2: "1-Click Macro",
    onboardingFeature3: "Private Notes",
    onboardingFeature4: "100% Security Compliant",
    onboardingStart: "Looks perfect! Let's start",
